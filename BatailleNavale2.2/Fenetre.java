...
public class Fenetre extends JFrame {
    ...
    public void affichageTirs(){
        ...
        JPanel tabButtonTest = new JPanel(new GridLayout(1, 5));
        tabButtonTest.setOpaque(false);
        tabButtonTest.setBorder(BorderFactory.createLineBorder(Color.black));
        Bateau[] tabBateau;
        if (model.getJoueurEnCours()==model.JOUEUR_1){
        ...
        for (int i = 0; i < tabBateau.length; i++) {
            ...
            tabButtonTest.add(but);
        }
        tabButtonTest.setBounds(727, 117, 98, 24);
        ...
        layeredPane.add(tabButtonTest, 1, 0);
